      ...
      <div className="flex-1 flex flex-col">
        ...
        >
          ...
          <div className="flex items-center gap-2">
            {participantMode === "streamer" && (
              <VideoQualitySettings theme={theme} />
            )}
            <button
              onClick={() =>
                setLayoutMode(
                ...
                onClick={() =>
                  setRoomSettings({
                    ...
                    showParticipantNames:
                      !roomSettings.showParticipantNames,
                  })
                }
                ...
                onClick={() =>
                  setRoomSettings({
                    ...
                    showConnectionQuality:
                      !roomSettings.showConnectionQuality,
                  })
                }
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors`}
                style={{
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={`px-3 py-1 rounded text-xs transition ${
                    roomSettings.chatPosition === "left"
                      ? "opacity-100"
                      : "opacity-50"
                  }`}
                  style={{
                ...
                <button
                  ...
                  className={`px-3 py-1 rounded text-xs transition ${
                    roomSettings.chatPosition === "right"
                      ? "opacity-100"
                      : "opacity-50"
                  }`}
                  style={{
        ...
        <div className="flex-1 overflow-y-auto p-4">
          {tracks.length === 0 ? (
            ...
            <div
              className={`grid ${getGridCols(tracks.length)} gap-4 h-full`}
            >
              {tracks
                .filter(
                  (track) =>
                ...
                .map((track) => (
                  <div
                    key={
                      ...
                      `${track.participant.identity}-${Date.now()}`
                    }
