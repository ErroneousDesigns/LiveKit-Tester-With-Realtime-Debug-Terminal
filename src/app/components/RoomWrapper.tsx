...
export function RoomWrapper({ theme, participantName, participantMode }: RoomWrapperProps) {
    ...
    return (
      <div className="flex items-center justify-center h-full">
        <div className="text-center">
          <div className="text-xl mb-2" style={{ color: theme.textColor }}>
            {connectionState === ConnectionState.Connecting ? 'Connecting to room...' :
             connectionState === ConnectionState.Reconnecting ? 'Reconnecting...' :
             'Establishing connection...'}
          </div>
          <div className="text-sm opacity-60" style={{ color: theme.textColor }}>
            Please wait
          </div>
        </div>
      </div>
  ...
  return <CustomVideoRoom theme={theme} participantName={participantName} participantMode={participantMode} />;
}
